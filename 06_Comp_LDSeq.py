...
param_filename = f'result/06_Comp_LDS/{param_func}_run{param_run}_fp'

param_ndims_lst = [2,4,6,8][::-1]
param_nitn = 15
param_nitn_pre = 0
param_neval = int(8e6) # 1e8
...
class LDSInteg():
    ...
    def set_func(self, func):
        ...
        logger.info('LDSInteg :: set_func (end)')
    ...
    def run_one_integration(self):
        # print('LDSInteg :: run_one_integration')
        # means, sdevs = [], []
